...
public static int indexOfMinInCol(int[][] data, int col) {
  ...
  int min = data[0][0], minIndex = 0;                              //Set the minimum value to the first value in the array and initialize the minIndex giving it the row value
  ...
  return minIndex;                                                 //Return just the row of the minimum value
}
