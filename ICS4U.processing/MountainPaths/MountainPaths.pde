...
void setup() {
  ...
  int[][] data = readData(dataPath("") + "/844x480.dat");
  ...
  boolean bestPath = false;                                                          //If this is the bestPath we pass drawLowestElevPath a boolean with true so it knows to change the colour
